...
### Troubleshoot Autonomous AI Agent Overview

In this lab, you will be troubleshooting an issue with an **Autonomous AI Agent**.

**It is important:** The user accounts have full access. Use this lab in read-only mode. You do not need to fix the issue by changing the configuration. Your goal is to find the problem from the logs.

### User accounts

Select any one account from the list below:
