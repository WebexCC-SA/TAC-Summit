...
# Mission 4: Configure Fulfillment Action and create an order using Webex Connect Flow. 
...
As the other option for Fulfillment, you can configure it in the Webex Connect flow.

Configure Fulfillment action to collect order details from the customer and send them to a third-party application via APIs.
