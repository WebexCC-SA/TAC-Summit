...
1. Open up the browser window with your AI agent and refresh it to make sure it is not timed out. If you closed it earlier you can always open it again. Your AI agent name should be **<copy><w class="attendee"></w>\_2000_AutoAI_Lab</copy>**.
   ![Profiles](../graphics/Lab1_AI_Agent/13.4.gif)

2. Under the **Profile** settings, in the **Welcome message** replace "there" with **<copy>{{customer_name}}</copy>**. In this case we expect that the caller will hear: "Hi **dear customer**, my name is Blossom, the AI Agent. How can I assist you?"
